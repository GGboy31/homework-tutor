...
一个面向 Codex 的作业辅导插件。以课件知识为首要解题依据，课件不足时查教材，之后才使用 AI 知识或联网资料，并说明各项依据的来源。

## 功能

- 支持教材题号、作业文件、照片、截图及组合题源。
- DOCX 先转为 PDF 并核对页面；图片由多模态模型直接查看，OCR 只作必要时的辅助。
- 题目条件直接采用；解题知识与缺失数据依次查课件、教材、AI 知识或网络，核对单位、近似和适用条件。
- 支持完整解答、提示、答案检查和概念追问。
